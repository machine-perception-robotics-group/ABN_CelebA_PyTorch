...
This network model is originally developed by Tsubasa Hirakawa by modifying resnet_mtabn_v1.py,
...
if __name__ == '__main__':
    ...
    model18 = mtabn_v3_resnet18(pretrained=True, num_classes=n_class, residual_attention=True)
    output18 = model18(input)
    print("output of resnet-18", output18[0].size(), output18[1].size(), output18[2].size())

    model34 = mtabn_v3_resnet34(pretrained=True, num_classes=n_class, residual_attention=True)
    output34 = model34(input)
    print("output of resnet-34", output34[0].size(), output34[1].size(), output34[2].size())

    model50 = mtabn_v3_resnet50(pretrained=True, num_classes=n_class, residual_attention=True)
    output50 = model50(input)
    print("output of resnet-50", output50[0].size(), output50[1].size(), output50[2].size())

    model101 = mtabn_v3_resnet101(pretrained=True, num_classes=n_class, residual_attention=True)
    output101 = model101(input)
    print("output1 of resnet-101", output101[0].size(), output101[1].size(), output101[2].size())

    model152 = mtabn_v3_resnet152(pretrained=True, num_classes=n_class, residual_attention=True)
