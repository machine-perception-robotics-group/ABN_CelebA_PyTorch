...
from mtabn.models import load_model, MODEL_NAMES_MTABN_V3_RESNET
...
def parser():
    ...
    ### network settings
    arg_parser.add_argument('--model', type=str, default='mtabn_v3_resnet50', choices=MODEL_NAMES_MTABN_V3_RESNET, help='network model')
    ...
    ### Focal loss settings
    arg_parser.add_argument('--alpha', type=float, default=-1, help='alpha parameter of Focal loss')
    arg_parser.add_argument('--gamma', type=float, default=2, help='gamma parameter of Focal loss')
